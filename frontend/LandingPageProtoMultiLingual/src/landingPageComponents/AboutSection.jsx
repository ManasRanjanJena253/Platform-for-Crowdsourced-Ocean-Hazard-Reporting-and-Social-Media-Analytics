...
// 1. Component accepts the 't' prop for translations
...
  ];
  ...
  // 2. The 'features' array is now built using the 't' function
  //    Icons are kept static while text is fetched from the translation file
  const features = [
  ...
  const cardVariants = { /* ... remains the same ... */ };
  const interactiveCardAnimation = { /* ... remains the same ... */ };
...
      </div>
      <div className="relative z-10 container mx-auto max-w-7xl">
        <div className="text-center max-w-4xl mx-auto mb-20">
          {/* 3. All static text is replaced with the 't' function */}
          <motion.h2 
        ...
        <motion.div 
          ...
          initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
          viewport={{ once: false }} transition={{ duration: 1, delay: 0.2 }}
        >
          <a
            href="#dashboard"
